...
public class ConexionActivity extends AppCompatActivity {
    //Log para pruebas
    private static final String TAG = "ActivityConectar";
    //ListView de dispositivos
    ListView IdLista;
    //String para que se enviara a la actividad principal
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(ConexionActivity.this, MenuPrincipalActivity.class);//<-<- PARTE A MODIFICAR >->->
